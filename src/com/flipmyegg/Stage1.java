...
public class Stage1 extends Activity {
	...
	final CounterClass timer = new CounterClass(10000, 500);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		backImage = getResources().getDrawable(R.drawable.s1);
		/*
	...
	public class CounterClass extends CountDownTimer {
		...
		public void onFinish() {
			if (counter == 3) {
				...
				editor.putString("score1", score);
				editor.commit();

				// Put extra
				Intent resulta = new Intent(Stage1.this, Score1.class);
	...
	private void endGame() {
		...
		if (turns >= 3 && turns <= 6) {
			...
			SharedPreferences.Editor editor = sharedPreferences.edit();
			editor.putString("score1", score);
			editor.putString("active1", active);
			editor.commit();

			// Put extra
			Intent resulta = new Intent(this.getBaseContext(), Score1.class);
	...
	private void loadImages() {
		...
		images.add(getResources().getDrawable(R.drawable.s1card1));
		images.add(getResources().getDrawable(R.drawable.s1card2));
		images.add(getResources().getDrawable(R.drawable.s1card3));
		images.add(getResources().getDrawable(R.drawable.s1card4));
		images.add(getResources().getDrawable(R.drawable.s1card5));
		images.add(getResources().getDrawable(R.drawable.s1card6));
		images.add(getResources().getDrawable(R.drawable.s1card7));
		images.add(getResources().getDrawable(R.drawable.s1card8));
		images.add(getResources().getDrawable(R.drawable.s1card9));
		images.add(getResources().getDrawable(R.drawable.s1card10));
