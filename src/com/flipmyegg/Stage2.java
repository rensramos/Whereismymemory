...
public class Stage2 extends Activity {
	...
	final CounterClass timer = new CounterClass(20000, 500);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		backImage = getResources().getDrawable(R.drawable.s2);
		/*
	...
	public class CounterClass extends CountDownTimer {
		...
		public void onFinish() {
			if (counter == 4) {
				...
				editor.putString("score2", score);
				editor.commit();

				// Put extra
				Intent resulta = new Intent(Stage2.this, Score2.class);
	...
	private void endGame() {
		...
		if (turns >= 4 && turns <= 7) {
			...
			SharedPreferences.Editor editor = sharedPreferences.edit();
			editor.putString("score2", score);
			editor.putString("active2", active);
			editor.commit();

			Intent resulta = new Intent(this.getBaseContext(), Score2.class);
	...
	private void loadImages() {
		...
		images.add(getResources().getDrawable(R.drawable.s2card1));
		images.add(getResources().getDrawable(R.drawable.s2card2));
		images.add(getResources().getDrawable(R.drawable.s2card3));
		images.add(getResources().getDrawable(R.drawable.s2card4));
		images.add(getResources().getDrawable(R.drawable.s2card5));
		images.add(getResources().getDrawable(R.drawable.s2card6));
		images.add(getResources().getDrawable(R.drawable.s2card7));
		images.add(getResources().getDrawable(R.drawable.s2card8));
		images.add(getResources().getDrawable(R.drawable.s2card9));
		images.add(getResources().getDrawable(R.drawable.s2card10));
