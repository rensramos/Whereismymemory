...
public class Stage4 extends Activity {
	...
	CounterClass timer = new CounterClass(40000, 500);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		backImage = getResources().getDrawable(R.drawable.s4);
		/*
	...
	public class CounterClass extends CountDownTimer {
		...
		public void onFinish() {
			if (counter == 8) {
				...
				editor.putString("score4", score);
				editor.commit();

				// Put extra
				Intent resulta = new Intent(Stage4.this, Score4.class);
	...
	private void endGame() {
		...
		if (turns >= 8 && turns <= 13) {
			...
			SharedPreferences.Editor editor = sharedPreferences.edit();
			editor.putString("score4", score);
			editor.putString("active4", active);
			editor.commit();

			Intent resulta = new Intent(this.getBaseContext(), Score4.class);
	...
	private void loadImages() {
		...
		images.add(getResources().getDrawable(R.drawable.s4card1));
		images.add(getResources().getDrawable(R.drawable.s4card2));
		images.add(getResources().getDrawable(R.drawable.s4card3));
		images.add(getResources().getDrawable(R.drawable.s4card4));
		images.add(getResources().getDrawable(R.drawable.s4card5));
		images.add(getResources().getDrawable(R.drawable.s4card6));
		images.add(getResources().getDrawable(R.drawable.s4card7));
		images.add(getResources().getDrawable(R.drawable.s4card8));
		images.add(getResources().getDrawable(R.drawable.s4card9));
		images.add(getResources().getDrawable(R.drawable.s4card10));
