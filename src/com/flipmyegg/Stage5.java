...
public class Stage5 extends Activity {
	...
	CounterClass timer = new CounterClass(60000, 500);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		backImage = getResources().getDrawable(R.drawable.s5);
		/*
	...
	public class CounterClass extends CountDownTimer {
		...
		public void onFinish() {
			if (counter == 10) {
				...
				editor.putString("score5", score);
				editor.commit();

				// Put extra
				Intent resulta = new Intent(Stage5.this, Score5.class);
	...
	private void endGame() {
		...
		if (turns >= 10 && turns <= 18) {
			...
			SharedPreferences.Editor editor = sharedPreferences.edit();
			editor.putString("score5", score);
			editor.putString("active5", active);
			editor.commit();

			Intent resulta = new Intent(this.getBaseContext(), Score5.class);
	...
	private void loadImages() {
		...
		images.add(getResources().getDrawable(R.drawable.s5card1));
		images.add(getResources().getDrawable(R.drawable.s5card2));
		images.add(getResources().getDrawable(R.drawable.s5card3));
		images.add(getResources().getDrawable(R.drawable.s5card4));
		images.add(getResources().getDrawable(R.drawable.s5card5));
		images.add(getResources().getDrawable(R.drawable.s5card6));
		images.add(getResources().getDrawable(R.drawable.s5card7));
		images.add(getResources().getDrawable(R.drawable.s5card8));
		images.add(getResources().getDrawable(R.drawable.s5card9));
		images.add(getResources().getDrawable(R.drawable.s5card10));
